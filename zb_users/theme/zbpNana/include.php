...
function zbpNana_links_nofollow(&$template){
	...
	if($matches){
		foreach($matches[2] as $val){
			if(strpos($val,'://')!==false && strpos($val,$zbp->host)===false && !preg_match('/\.(jpg|jepg|png|ico|webp|bmp|gif|tiff)/i',$val)){
